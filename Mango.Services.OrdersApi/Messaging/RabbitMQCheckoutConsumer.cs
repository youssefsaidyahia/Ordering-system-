...
namespace Mango.Services.OrdersApi.Messaging
{
    public class RabbitMQCheckoutConsumer : BackgroundService
    {
        ...
        private readonly IRabbitMQOrderSender _rabbitMQOrderMessageSender;

        public RabbitMQCheckoutConsumer(OrderRepository orderRepository, IRabbitMQOrderSender rabbitMQOrderMessageSender)
        {
