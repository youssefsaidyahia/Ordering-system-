...
namespace Mango.Services.ShoppingCartApi.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> CleareCart(string userId)
        {
            var cartHeaderFromDb = await _db.cartHeaders.FirstOrDefaultAsync(u => u.UserId == userId);
            if (cartHeaderFromDb != null)
            {
                _db.CartDetails.RemoveRange(_db.CartDetails.Where(u => u.CartHeaderId ==
        ...
        public async Task<CartDto> GetCartByUseId(string userId)
        {
            Cart cart = new()
            {
        ...
        {
            var cart = await _db.cartHeaders.FirstOrDefaultAsync(u => u.UserId == userId);
